...
public class BadController {
	...
	public Thumbstick getRightThumbstick() {
		return new BadController.Thumbstick(gamepad.right_stick_x, gamepad.right_stick_y);
	}
	
	public Thumbstick getLeftThumbstick() {
		return new BadController.Thumbstick(gamepad.left_stick_x, gamepad.left_stick_y);
	}
