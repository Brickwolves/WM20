		...
		switch ((int) ringCount) {
			...
			case 4:
				switch (currentMainState) {
					...
					//drive to power shot shooting position
					case state4Drive:
						robot.strafe(32.5, -140, -139, 1, 0, 0);
